...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "6365381442:AAFbH4RU9n2ijllkXnsm5Gf7QRjwxIujVf8")  # Bot token from @BotFather
ADMINS = (
    [int(i.strip()) for i in os.environ.get("ADMINS").split("5736579519")]
...
#  Optionnal variables
LOG_CHANNEL = int(
    os.environ.get("LOG_CHANNEL", "-1001820032237")
)  # log channel for information about users
UPDATE_CHANNEL = os.environ.get(
    "UPDATE_CHANNEL", "moneycaseofficial")  # For Force Subscription
